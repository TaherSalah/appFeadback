...
class AppUpdates {
  ...
  static final List<AppFeature> updateFeatures = [
    AppFeature(
      title: 'تحسين التمرير التلقائي للمصحف',
      description:
      'تحسين تجربة التمرير التلقائي داخل المصحف لتكون أكثر سلاسة وراحة أثناء القراءة',
      imagePath: 'assets/images/1_12_11zon.webp',
    ),
    AppFeature(
      title: 'حل مشكلة اختفاء خط التجويد عند تكبير الخط',
      description:
      'تم إصلاح مشكلة اختفاء ألوان وخطوط التجويد عند تكبير حجم الخط داخل المصحف',
      imagePath: 'assets/images/4_15_11zon.webp',
    ),
    AppFeature(
      title: 'حل مشكلة تصفير المسبحة الإلكترونية',
      description:
      'تم إصلاح مشكلة تصفير العداد عند الخروج من المسبحة والعودة إليها مع الحفاظ على العدد',
      imagePath: 'assets/images/17_8_11zon.webp',
    ),
    AppFeature(
      title: 'تحسينات عامة',
      description:
      'إجراء مجموعة من التحسينات على الأداء وتجربة الاستخدام داخل التطبيق',
      imagePath: 'assets/images/17_8_11zon.webp',
    ),
  ];

...
class AssetsManager {
  static const String logo = "${_imagePath}logoApp.png";
  static const String arrowLeft = "${_imagePath}left.png";
  static const String filter = "${_imagePath}filter.png";
  static const String time = "${_imagePath}illustration_time_.png";
  static const String homeIcon = "${_imagePath}home_icon.png";
  static const String arrowRight = "${_imagePath}right.png";
  static const String envelopeNewIc = "${_iconPath}Envelope_new.svg";
  static const String cartIcon = "${_iconPath}cart.svg";
  static const String welcomeIc = "${_iconPath}welcome.svg";
  static const String offlineNetWork = "${_imagePath}offlineNetWork.png";
  static const String emptyFavorite = "${_imagePath}favEmpty.png";
  static const String emptyImage = "${_imagePath}imageNot.png";
  static const String sliderOne = "${_imagePath}slider_one.png";
  static const String sliderTwo = "${_imagePath}slider_two.png";
  static const String jsonDelete = '${_jsonPath}delete.json';
  static const String jsonDone = '${_jsonPath}done.json';
  static const String jsonLoader = '${_jsonPath}loader.json';
  static String kOnboardingFirst = 'assets/images/2151457427.jpg';
  static String kOnboarding1 = '${_imagePath}2151457427.jpg';
  static String kOnboarding2 = '${_imagePath}2151457416.jpg';
  static String kOnboarding3 = '${_imagePath}2151101554.jpg';
  static const String loaderGif = "${_jsonPath}loader.gif";
  static const String sliderStackTop = "${_imagePath}slider_stack_top.png";
  static const String sliderStackBottom =
      "${_imagePath}slider_stack_bottom.png";
  static const String defImageInGoogle =
      "https://graph.facebook.com/v3.3/357093536936955/picture?type=normal";
  static const noResultsIllistration = '''

      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isDark ? const Color(0xFF1E293B) : const Color(0xFFF1F8E9), // Light Green bg
                   ...
                   children: List.generate(_sunnahs.length, (index) {
                     ...
                     return InkWell(
                       ...
                       child: AnimatedContainer(
                         ...
                         decoration: BoxDecoration(
                           color: isDone ? Colors.green : (isDark ? Colors.white10 : Colors.white),
                           borderRadius: BorderRadius.circular(20),
                         ...
                         child: Row(
                           ...
                           children: [
                             if(isDone) const Icon(Icons.check, color: Colors.white, size: 16),

...
class QuranAudioViewItemBuilder extends StatelessWidget {
  const QuranAudioViewItemBuilder({super.key});
      ...
      slivers: [
        ...
        SliverToBoxAdapter(child: BlocBuilder<QuranAudioBloc, QuranAudioState>(
          builder: (BuildContext context, state) {
            if (state is QuranRecitersStateSuccess) {
              return Padding(
            ...
            } else if (state is QuranRecitersStateSuccess) {
              return Padding(
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                child: Row(
                  children: [
              ...
              return state.maybeMap(
                ...
                successReciters: (value) {
                  return GridView.builder(
                      padding: EdgeInsets.zero,
                      itemCount: value.quranAudioModal?.reciters.length,
                      shrinkWrap: true,
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: InkWell(
                              onTap: () {
                                // Navigator.pushNamed(
                                //     context, Routes.quranDetailsRoute,
                                //     arguments: {
                                //     "reciterId": value.quranAudioModal?.reciters[index].reciterId ?? "",
                                //     "index": index});
                              },
                              child: Card(
                                shadowColor:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      TextWidget(
                                        maxLines: 2,
                                        title: value
                                            .quranAudioModal?.reciters[index].reciterName
                                            .toString() ??
                                            "",
                                        color: CentralizedCubit.isDarkMode
                                            ? KColors.scoColor

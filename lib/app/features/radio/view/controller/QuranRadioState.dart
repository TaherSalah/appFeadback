...
class QuranRadioState with _$QuranRadioState {
  ...
  const factory QuranRadioState.error({required KFailure failure}) = QuranRadioStateError;
  const factory QuranRadioState.success(
      {QuranRadioModel? quranRadioModel}) = QuranRadioStateSuccess;

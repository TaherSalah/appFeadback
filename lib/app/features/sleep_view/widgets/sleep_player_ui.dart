...
class SleepPlayerUI extends GetView<SleepController> {
  const SleepPlayerUI({super.key});
            ...
            child: Row(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    SleepController.performerImageAsset,
                    width: 40,
                    height: 40,
                    fit: BoxFit.cover,
              ...
              children: [
                              ...
                              child: Directionality(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'أذكار النوم • صوت هادئ ومريح للمساعدة على الاسترخاء',
                                      style: TextStyle(
                  fontFamily: "cairo",
                ...
                Directionality(
                  ...
                  child: controller.isDownloaded
                      ? TextButton.icon(
                          ...
                          label: Text(
                            'تم تحميل أذكار النوم، تعمل بدون إنترنت',
                            style: GoogleFonts.notoKufiArabic(
                              fontSize: 12,
                      ...
                      : TextButton.icon(
                          ...
                          label: Text(
                            controller.isDownloading ? 'جاري تحميل أذكار النوم...' : 'تحميل للتشغيل بدون إنترنت',
                            style: TextStyle(
                  fontFamily: "cairo",
                              fontSize: 13,
                              fontWeight: FontWeight.w700,
                ...
                Padding(
                  ...
                  child: Directionality(
                    textDirection: ui.TextDirection.rtl,
                    child: Text(
                      'استمع لأذكار النوم بهدوء وخشوع، واستشعر السكينة والطمأنينة قبل النوم.',
                      style: TextStyle(
                  fontFamily: "cairo",
                        fontSize: 12.5,
                        height: 1.6,

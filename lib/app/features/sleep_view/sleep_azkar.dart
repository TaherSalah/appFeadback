...
class _SleepAzkarState extends State<SleepAzkar> {
  ...
  static const String _masaUrl =
      'https://cdn.jsdelivr.net/gh/TaherSalah/azkarAudio@main/sleep.mp3';
  static const String _masaKey = 'sleep_audio_path';
  static const String _fileName = 'azkar_sleep.mp3';
  ...
  // Full player constants (غيّرهم حسب أصولك)
  ...
  Future<void> _initAudio() async {
    ...
    // لو عندك bufferingStream في AudioManager
  ...
  Future<void> _downloadAudio() async {
    ...
    try {
      ...
      setState(() => _isDownloaded = true);
      KHelper.showSuccess(
          message: 'تم تحميل أذكار النوم، يمكن تشغيلها بدون إنترنت.');
    } catch (e) {
  ...
  @override
  void dispose() {
    final con = Provider.of<AzkarProvider>(context, listen: false);
    con.resetSleep();
    super.dispose();
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Directionality(
                    textDirection: ui.TextDirection.rtl,
                    child: Text(
                      'استمع للأذكار بهدوء وخشوع قبل النوم.',
                      style: GoogleFonts.cairo(
                        fontSize: 12.5,
                        height: 1.6,
  ...
  Widget build(BuildContext context) {
    ...
    final bool allDone = Azkary.azkarSleepRepate.every((c) => c <= 0);
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, zSleepIndex) {
                          ...
                          final bool isDone =
                              Azkary.azkarSleepRepate[zSleepIndex] <= 0;
...
class DoneDialogWidget extends StatelessWidget {
  const DoneDialogWidget({
    ...
    required this.KZakarFeaturesTitle,
    required this.KDaialogText,
    this.repratBtn,
  });

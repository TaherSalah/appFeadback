...
// // ================== إعدادات الصوت ==================
//   static const String _sleepUrl = 'https://cdn.jsdelivr.net/gh/TaherSalah/azkarAudio@main/sleep.mp3';
//   static const String _sleepKey = 'sleep_audio_path';
...
//     final savedPath = await _audioManager.getSavedAudioPath(_sleepKey);
//     if (savedPath != null) {
//       _isDownloaded = true;
//     }
//
...
class _SleepAzkarState extends State<SleepAzkar> {
  ...
  @override
  void dispose() {
    // إعادة عدادات أذكار النوم عند ترك الشاشة
  ...
  Widget build(BuildContext context) {
    ...
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final double fontSize = CentralizedCubit.get(context).azkarFontSize();
    final bool allDone = Azkary.azkarSleepRepate.every((count) => count <= 0);
    return Scaffold(
      appBar: PreferredSize(
          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, zSleepIndex) {
                ...
                // الذكر خلص لما عدّاده صفر أو أقل
                final bool isDone =
              ...
              separatorBuilder: (context, zSleepIndex) =>

...
class _TasbihScreenState extends State<TasbihScreen>
      ...
      if (dhikr.currentCount < dhikr.targetCount) {
        ...
        if (dhikr.currentCount == dhikr.targetCount) {
          ...
          if (currentDhikrIndex < widget.wird.adhkar.length - 1) {
            Future.delayed(
                const Duration(milliseconds: 1000), () => _goToNextDhikr());
          } else {
            _completeWird();
          }
        }
  ...
  void _completeWird() async {
    ...
    final totalTasbihat =
        widget.wird.adhkar.fold<int>(0, (sum, d) => sum + d.targetCount);
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        backgroundColor:
            context.isDark ? const Color(0xFF0F0F0F) : const Color(0xFFF0F4F4),
        body: Stack(
          children: [
            Positioned.fill(
              child: Opacity(
            ...
            SafeArea(
              child: Column(
                children: [
                  _buildAppBar(context.isDark, isFocusMode),
                  _buildTopProgressIndicator(context.isDark, primaryColor),
                  Expanded(
                    child: PageView.builder(
                      controller: _pageController,
                      onPageChanged: (index) =>
                          setState(() => currentDhikrIndex = index),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildCounterWidget(dhikr, isCompleted,
                          ...
                          fontFamily: "cairo",
                                    ...
                                    SizedBox(height: 32.h),
                                    _buildControlsRow(context.isDark),
                                  ],
                                ],
                              ),
                            ),
  ...
  Widget _buildCounterWidget(
      Dhikr dhikr, bool isCompleted, bool isDark, Color primaryColor) {
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: isDark
                    ...
                    : [Colors.white, const Color(0xFFF8FBFB)],
              ),
              boxShadow: [
                BoxShadow(
  ...
  Widget _buildControlsRow(bool isDark) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildControlButton(CupertinoIcons.chevron_right, 'السابق',
              _goToPreviousDhikr, currentDhikrIndex > 0, false),
          SizedBox(width: 20.w),
          _buildControlButton(CupertinoIcons.forward_fill, 'تخطي',
              _skipCurrentDhikr, true, true),
          SizedBox(width: 20.w),
          _buildControlButton(
              CupertinoIcons.chevron_left,
              'التالي',
              _goToNextDhikr,
              currentDhikrIndex < widget.wird.adhkar.length - 1,
              false),
          SizedBox(width: 20.w),
          _buildControlButton(
              ...
              'إعادة',
              () => setState(
                  () => widget.wird.adhkar[currentDhikrIndex].currentCount = 0),
              true,
              false),
        ],
      ),
          ...
          CupertinoButton(
            ...
            child: Container(
              ...
              child: Icon(CupertinoIcons.back,
                  color: isDark ? Colors.white70 : Colors.black87, size: 20.sp),
            ),
            onPressed: () => Navigator.pop(context),
          ),
          if (!isFocus)

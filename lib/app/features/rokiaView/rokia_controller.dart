...
class RokiaController extends GetxController {
  static const String roqiaUrl = 'https://cdn.jsdelivr.net/gh/TaherSalah/azkarAudio@main/roqia.mp3';
  static const String roqiaKey = 'roqia_audio_path';
  static const String fileName = 'azkar_roqia.mp3';
  ...
  Future<void> _initAudio() async {
    ...
    final savedPath = await audioManager.getSavedAudioPath(roqiaKey);
    if (savedPath != null) {
  ...
  Future<void> downloadAudio() async {
    ...
    try {
      ...
      _isDownloaded.value = true;
      KHelper.showSuccess(message: 'تم تحميل الرقية الشرعية، يمكن تشغيلها بدون إنترنت.');
    } catch (e) {

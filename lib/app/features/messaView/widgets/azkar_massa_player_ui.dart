...
class AzkarMassaPlayerUI extends StatelessWidget {
  const AzkarMassaPlayerUI({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      return Stack(
        children: [
          // 🔸 الميني بلاير
          if (controller.showMiniPlayer) _buildMiniPlayer(context, controller, isDark),
          // 🔹 البلاير الكامل
          _buildFullPlayer(context, controller, isDark),
        ],
      );
    });
  }

  Widget _buildMiniPlayer(BuildContext context, AzkarMassaController controller, bool isDark) {
    final primaryColor = isDark ? KColors.primaryColor : Theme.of(context).colorScheme.primary;
          ...
          child: Row(
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  AzkarMassaController.performerImageAsset,
                  width: 48,
                  height: 48,
                  fit: BoxFit.cover,
                ),
              ...
              IconButton(
                onPressed: () => controller.toggleMiniPlayer(false),
  ...
  Widget _buildFullPlayer(BuildContext context, AzkarMassaController controller, bool isDark) {

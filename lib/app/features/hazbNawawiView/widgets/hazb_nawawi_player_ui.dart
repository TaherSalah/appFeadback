...
class HazbNawawiPlayerUI extends GetView<HazbNawawiController> {
  const HazbNawawiPlayerUI({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      if (controller.showFullPlayer) {
        return _buildFullPlayer(context, isDark, primaryColor);
      } else if (controller.showMiniPlayer) {
        return _buildMiniPlayer(context, isDark, primaryColor);
      }
          ...
          child: Row(
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset(
                  HazbNawawiController.performerImageAsset,
                  width: 45,
                  height: 45,
                  fit: BoxFit.cover,
                ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                      ...
                      IconButton(
                        onPressed: durationMs == 0
                            ...
                            : () async {
                                ...
                                await controller.audioManager.seek(
                ...
                GestureDetector(
                  onTap: () {
                    if (!controller.isDownloaded && controller.isBuffering) {
                      return;
                    }
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: primaryColor
                              .withOpacity(controller.isPlaying ? 0.6 : 0.35),

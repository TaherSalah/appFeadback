...
class AzkarSabahController extends GetxController {
  // ================== إعدادات الصوت ==================
  static const String sabahUrl =
      'https://cdn.jsdelivr.net/gh/TaherSalah/azkarAudio@main/sabah.mp3';
  static const String sabahKey = 'sabah_audio_path';
  static const String fileName = 'azkar_sabah.mp3';
  ...
  void onInit() {
    super.onInit();
    _initAudio();
    NotificationManager().registerSabahAzkarVisit();
  }

  Future<void> _initAudio() async {
    audioManager.initialize();

    final savedPath = await audioManager.getSavedAudioPath(sabahKey);
    if (savedPath != null) {

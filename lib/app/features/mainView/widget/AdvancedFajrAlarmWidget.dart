                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: List.generate(7, (index) {
                                // Reorder to start from Saturday (6) if preferred, but here we use 1-7
                                // Let's use 6, 7, 1, 2, 3, 4, 5 for Arabic week (Sat-Fri)
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _getDayName(day).length > 6
                                          ...
                                          : _getDayName(day), // Use more of the name visibility
                                      style: GoogleFonts.cairo(
                                        fontSize: 10.sp,
                                        color: isSelected
                                            ? goldColor

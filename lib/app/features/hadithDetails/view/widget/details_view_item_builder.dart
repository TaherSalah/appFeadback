    ...
    return BlocBuilder<HadithDetailsBloc, HadithDetailsState>(
      builder: (BuildContext context, state) {
        return BlocBuilder<CentralizedCubit, CentralizedState>(
          builder: (context, centralizedState) {
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border(
                                      right: BorderSide(
                                          color: KColors.yalloColor,
                                          width: 4))),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  TextWidget(
                                      title: bloc.hadithDetailsModal
                                              ?.attribution ??
                                          "غير متوفر",
                                      height: 2,
                                      fontFamily: "me",
                          ...
                          child: Container(
                              ...
                              child: Column(
                                children: [
                                  TextWidget(
                                      title: bloc
                                              .hadithDetailsModal?.explanation
                                              .toString()
                                              .replaceAll("،", "")
                                              .replaceAll("؛", "")
                                              .replaceAll("؟", "") ??
                        ...
                        Padding(
                            ...
                            child: HeadTitleItemBuilder(
                                ...
                                headTitle: LocalizationManager.call(
                                    "hadith-vocabulary"),
                                lineColor: KColors.scoColor)),
                        bloc.hadithDetailsModal?.wordsMeanings?.isNotEmpty ==
                                true
                            ? Padding(
                                ...
                                child: Wrap(
                                  children: bloc
                                          .hadithDetailsModal?.wordsMeanings
                                          ?.map((word) {
                                        return Padding(
                                          padding: EdgeInsets.symmetric(
                                              vertical: ResponsiveUtil.isTablet(
                                                      context)
                                                  ? 5.h
                                                  : 1.5.h),
                                          child: Container(
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.start,
                                children:
                                    bloc.hadithDetailsModal?.hints?.map((e) {
                                          return TextWidget(
                                              title:
